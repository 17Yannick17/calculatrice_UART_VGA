...
entity cpu is
    port(
        ...
        Bus_o : out std_logic_vector(9 downto 0);
        done : out std_logic;
...
--		  data0_o,data1_o,data2_o,data3_o,data4_o,data5_o : out std_logic_vector(9 downto 0);
--		  data6_o,data7_o,dataA_o,dataG_o, dataIR_o : out std_logic_vector(9 downto 0)
    );
end cpu;
